const properties = {
  ...
  lead: { color: lead, damage: 375, tier: 'iron' },
  nickel: { color: nickel, damage: 320, tier: 'iron' },
  zinc: { color: zinc, damage: 260, tier: 'iron' },
  osmium: { color: osmium, damage: 840, tier: 'diamond' },
  copper: { color: copper, damage: 200, tier: 'stone' },
  steel: { color: steel, damage: 710, tier: 'iron' },
  ...
  bronze: { color: bronze, damage: 670, tier: 'iron' },
